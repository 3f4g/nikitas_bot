...
// ⚡ Безлимитный доступ к базе из более чем 1000 тестов по гистологии.  
...
//     // await ctx.editMessageText('Меню подписки:', subscriptionMenu, { parse_mode: 'HTML' });
...
//     await ctx.answerCbQuery();
//     await ctx.editMessageText('Выбери вариант подписки:', planMenu);
//   });

//   bot.action('sub_promo', async (ctx) => {
//     await ctx.answerCbQuery();
//     await ctx.editMessageText('Введите промокод:', backButton);
//   });

//   bot.action('plan_month', async (ctx) => {
//     await ctx.answerCbQuery();
//     await ctx.editMessageText('Оформление подписки: "1 месяц — 599₽"', backButton);
//   });

//   bot.action('plan_year', async (ctx) => {
//     await ctx.answerCbQuery();
//     await ctx.editMessageText('Оформление подписки: "1 год — 999₽"', backButton);
//   });

//   bot.action('plan_lifetime', async (ctx) => {
//     await ctx.answerCbQuery();
//     await ctx.editMessageText('Оформление подписки: "Навсегда — 1299₽"', backButton);
//   });
